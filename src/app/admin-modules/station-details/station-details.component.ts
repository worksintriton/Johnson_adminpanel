...
export class StationDetailsComponent implements OnInit {
  ...
  addUser(){
    this.adminService.createstation(this.addUserForm.value).subscribe(data=>{
      const response:any = data;
      console.log(response);
  ...
  deleteUser(){
    this.dataLoaded = false;
    this.adminService.deletestation(this.selectedData_ID).subscribe(data=>{
      const response:any = data;
      if (response['Status'] == "Success") {
        this.showSuccess(response['Message']);
        this.cancel();
  ...
  updateUser(){
    this.dataLoaded = false;
    this.adminService.updatestation(this.addUserForm.value).subscribe(data=>{
      const response:any = data;
      if (response['Status'] == "Success") {
        this.showSuccess(response['Message']);
        this.cancel();
